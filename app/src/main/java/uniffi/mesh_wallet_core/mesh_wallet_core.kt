...
package uniffi.mesh_wallet_core;
...
private fun findLibraryName(componentName: String): String {
    ...
    return "uniffi_mesh_wallet_core"
}
...
internal interface UniffiCallbackInterfaceHardwareSignerMethod0 : com.sun.jna.Callback {
...
internal interface UniffiCallbackInterfaceHardwareSignerMethod1 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`uniffiOutReturn`: RustBuffer,uniffiCallStatus: UniffiRustCallStatus,)
}
internal interface UniffiCallbackInterfaceHardwareSignerMethod2 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`unitId`: Int,`uniffiOutReturn`: ByteByReference,uniffiCallStatus: UniffiRustCallStatus,)
}
@Structure.FieldOrder("sign", "publicKey", "advanceCounter", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceHardwareSigner(
    @JvmField internal var `sign`: UniffiCallbackInterfaceHardwareSignerMethod0? = null,
    @JvmField internal var `publicKey`: UniffiCallbackInterfaceHardwareSignerMethod1? = null,
    @JvmField internal var `advanceCounter`: UniffiCallbackInterfaceHardwareSignerMethod2? = null,
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
) : Structure() {
    class UniffiByValue(
        `sign`: UniffiCallbackInterfaceHardwareSignerMethod0? = null,
        `publicKey`: UniffiCallbackInterfaceHardwareSignerMethod1? = null,
        `advanceCounter`: UniffiCallbackInterfaceHardwareSignerMethod2? = null,
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    ): UniffiVTableCallbackInterfaceHardwareSigner(`sign`,`publicKey`,`advanceCounter`,`uniffiFree`,), Structure.ByValue

   internal fun uniffiSetValue(other: UniffiVTableCallbackInterfaceHardwareSigner) {
        `sign` = other.`sign`
        `publicKey` = other.`publicKey`
        `advanceCounter` = other.`advanceCounter`
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "mesh_wallet_core")
            .also { lib: UniffiLib ->
                uniffiCheckContractApiVersion(lib)
                uniffiCheckApiChecksums(lib)
                uniffiCallbackInterfaceHardwareSigner.register(lib)
                }
        }
...
public interface WalletCoreInterface {
    ...
    fun `receiveSpend`(`spend`: SignedSpendFfi): kotlin.UInt
    
    fun `spendNextUnit`(`unitId`: kotlin.UInt, `recipientPubkey`: kotlin.ByteArray): SignedSpendFfi
    
    companion object
}

open class WalletCore: Disposable, AutoCloseable, WalletCoreInterface {
    ...
    @Throws(WalletException::class)override fun `receiveSpend`(`spend`: SignedSpendFfi): kotlin.UInt {
    ...
    @Throws(WalletException::class)override fun `spendNextUnit`(`unitId`: kotlin.UInt, `recipientPubkey`: kotlin.ByteArray): SignedSpendFfi {
...
public object FfiConverterTypeWalletCore: FfiConverter<WalletCore, Pointer> {

    override fun lower(value: WalletCore): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): WalletCore {
        return WalletCore(value)
    }

    override fun read(buf: ByteBuffer): WalletCore {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: WalletCore) = 8UL

    override fun write(value: WalletCore, buf: ByteBuffer) {
...
data class SignedSpendFfi (
    var `unitId`: kotlin.UInt, 
    var `payload`: kotlin.ByteArray, 
    var `signature`: kotlin.ByteArray, 
    var `senderPubkey`: kotlin.ByteArray
) {
    
    companion object
}

public object FfiConverterTypeSignedSpendFfi: FfiConverterRustBuffer<SignedSpendFfi> {
    override fun read(buf: ByteBuffer): SignedSpendFfi {
        return SignedSpendFfi(
    ...
    override fun allocationSize(value: SignedSpendFfi) = (
            FfiConverterUInt.allocationSize(value.`unitId`) +
            FfiConverterByteArray.allocationSize(value.`payload`) +
            FfiConverterByteArray.allocationSize(value.`signature`) +
            FfiConverterByteArray.allocationSize(value.`senderPubkey`)
    )

    override fun write(value: SignedSpendFfi, buf: ByteBuffer) {
            FfiConverterUInt.write(value.`unitId`, buf)
            FfiConverterByteArray.write(value.`payload`, buf)
            FfiConverterByteArray.write(value.`signature`, buf)
            FfiConverterByteArray.write(value.`senderPubkey`, buf)
    }
}
...
sealed class WalletException(message: String): Exception(message) {
        ...
        class CounterRefused(message: String) : WalletException(message)
        
        class PointerExhausted(message: String) : WalletException(message)
        
        class InvalidSignature(message: String) : WalletException(message)
        
        class WrongRecipient(message: String) : WalletException(message)
...
public object FfiConverterTypeWalletError : FfiConverterRustBuffer<WalletException> {
    override fun read(buf: ByteBuffer): WalletException {
            ...
            1 -> WalletException.CounterRefused(FfiConverterString.read(buf))
            2 -> WalletException.PointerExhausted(FfiConverterString.read(buf))
            3 -> WalletException.InvalidSignature(FfiConverterString.read(buf))
            4 -> WalletException.WrongRecipient(FfiConverterString.read(buf))
    ...
    override fun write(value: WalletException, buf: ByteBuffer) {
        when(value) {
            is WalletException.CounterRefused -> {
                buf.putInt(1)
                Unit
            }
            is WalletException.PointerExhausted -> {
                buf.putInt(2)
                Unit
            }
            is WalletException.InvalidSignature -> {
                buf.putInt(3)
                Unit
            }
            is WalletException.WrongRecipient -> {
                buf.putInt(4)
                Unit
            }
...
public interface HardwareSigner {
    ...
    fun `advanceCounter`(`unitId`: kotlin.UInt): kotlin.Boolean
...
internal object uniffiCallbackInterfaceHardwareSigner {
    internal object `sign`: UniffiCallbackInterfaceHardwareSignerMethod0 {
        override fun callback(`uniffiHandle`: Long,`payload`: RustBuffer.ByValue,`uniffiOutReturn`: RustBuffer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeHardwareSigner.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`sign`(
    ...
    internal object `publicKey`: UniffiCallbackInterfaceHardwareSignerMethod1 {
    ...
    internal object `advanceCounter`: UniffiCallbackInterfaceHardwareSignerMethod2 {
        override fun callback(`uniffiHandle`: Long,`unitId`: Int,`uniffiOutReturn`: ByteByReference,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeHardwareSigner.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`advanceCounter`(
                    FfiConverterUInt.lift(`unitId`),
                )
            }
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeHardwareSigner.handleMap.remove(handle)
        }
    }

    internal var vtable = UniffiVTableCallbackInterfaceHardwareSigner.UniffiByValue(
        `sign`,
        `publicKey`,
        `advanceCounter`,
        uniffiFree,
